...
const ThemeSettings = () => {
  const { setColor, setMode, currentMode, currentColor,setCurrentColor, setThemeSetting } = useStateContext();
  return (
    <div className="bg-half-transparent w-screen fixed nav-item top-0 right-0">
      <div className="float-right h-screen dark:text-gray-200 bg-white dark:[#484B5] w-400">
