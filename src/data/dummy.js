...
import { BsKanban, BsBarChart, BsBoxSeam, BsCurrencyDollar, BsShield, BsChatLeft, BsBookmarks } from 'react-icons/bs';
...
export const gridOrderImage = (props) => (
  <div>
    <img
      className="rounded-xl h-15 md:ml-3"
